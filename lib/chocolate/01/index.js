...
function Chocolate() {
    ...
    var hanleType = function hanleType() {
        var hash = location.hash;
        var isDefault = hash === '#a' || hash === '' ? true : false;
        chaneType(isDefault);
    };

    var handleClick = function handleClick(e) {
        var hash = location.hash;
        var newHash = hash === '#a' || hash === '' ? 'b' : 'a';
    ...
    return React.createElement(
        ...
        isTypeDefault === true ? React.createElement(
            React.Fragment,
            null,
